...
A set/reset latch, or SR latch, works by relying on the the values of the $S$ and $R$ signals. It can be made from two NOR gates that have cross-feedback loop, as shown in Figure.
