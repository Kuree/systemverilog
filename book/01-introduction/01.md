...
![Using two NOR gates to build a SR-Latch.](images/01-introduction/sr-latch.svg){#fig:sr-latch}
...
![D flip-flop symbol. Triangle indicates clock input.](images/01-introduction/d-flip-flop.svg){#fig:d-flip-flop}
...
![Timing diagram for setup time and hold time](images/01-introduction/setup-hold-time.svg){#fig:setup-hold-time}
